                    ...
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-green-200">
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-medium text-gray-800">Test your own devices</h3>
                                    <p className="text-gray-600 text-sm mt-0.5">
                                        Only target numbers you own or manage
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-medium text-gray-800">Use for app development</h3>
                                    <p className="text-gray-600 text-sm mt-0.5">
                                        Perfect for testing SMS-based 2FA systems
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-medium text-gray-800">Verify emergency systems</h3>
                                    <p className="text-gray-600 text-sm mt-0.5">
                                        Test mass notification delivery for organizations
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white rounded-xl shadow-lg overflow-hidden border border-red-200">
                        ...
                        <div className="p-6 space-y-4">
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-medium text-gray-800">Spam strangers</h3>
                                    <p className="text-gray-600 text-sm mt-0.5">
                                        Harassment is illegal in most jurisdictions
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-medium text-gray-800">Target emergency services</h3>
                                    <p className="text-gray-600 text-sm mt-0.5">
                                        Never test against 911, hospitals, etc.
                                    </p>
                                </div>
                            </div>
                            <div className="flex items-start gap-3">
                                ...
                                <div>
                                    <h3 className="font-medium text-gray-800">Use for phishing</h3>
                                    <p className="text-gray-600 text-sm mt-0.5">
                                        Fraudulent messages carry serious legal consequences
                                    </p>
                                </div>
                            </div>
                        </div>
